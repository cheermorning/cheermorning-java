package com.cheermorning.principle.segregation;
...
class B implements Interface1 {
    ...
    public void operation4() {
        System.out.println("B 实现了 Interface1的operation4");
    }

    public void operation5() {
        System.out.println("B 实现了 Interface1的operation5");
    }
}
...
class D implements Interface1 {
    ...
    public void operation2() {
        System.out.println("D 实现了 Interface1的operation2");
    }

    public void operation3() {
        System.out.println("D 实现了 Interface1的operation3");
    }
